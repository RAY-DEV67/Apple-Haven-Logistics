          ...
          <div className="space-y-8">
            <div>
              <h2 className="text-4xl font-bold text-brand-text mb-6">
                About {BrandDetails.name}
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Founded with a vision to revolutionize the logistics industry,{" "}
                {BrandDetails.name} has been your trusted partner for over 15
                years. We combine cutting-edge technology with personalized
                service to deliver exceptional results.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Our commitment to excellence, safety, and reliability has made
                us a leader in the logistics sector. From small packages to
                large freight, we handle every shipment with the utmost care and
                precision.
              </p>
            </div>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Real-time tracking and automated systems
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      Worldwide partnerships for seamless delivery
                    </p>
                  </div>
                </div>
              </div>
