...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center bg-gradient-to-br from-brand-gray to-brand-white"
    >
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                {BrandDetails.name} delivers excellence in shipping,
                warehousing, and distribution. We ensure your cargo reaches its
                destination safely, on time, every time.
              </p>
            </div>
