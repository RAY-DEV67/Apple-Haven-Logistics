  ...
  const services = [
    {
      ...
      description: "Fast and reliable shipping solutions for urgent deliveries with real-time tracking.",
    ...
    },
    {
      ...
      features: ["Custom packaging", "Fragile handling", "Eco-friendly options"]
    },
    {
      icon: <Globe className="w-12 h-12 text-primary" />,
      title: "International Freight",
      description: "Global shipping solutions with customs clearance and documentation.",
    ...
    <section id="services" className="py-20 bg-brand-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-brand-text mb-4">Our Services</h2>
