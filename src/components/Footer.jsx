        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              />
              <div>
                <h3 className="text-xl font-bold">{BrandDetails.name}</h3>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a
                  href="#"
                  className="text-brand-white/80 hover:text-brand-white transition-colors"
                >
                  Express Shipping
                </a>
              </li>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start space-x-3">
                ...
                <p className="text-brand-white/80">{BrandDetails.address}</p>
              </div>
              <div className="flex items-center space-x-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-brand-white/80">{BrandDetails.email}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-brand-white/20 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-brand-white/60 text-sm text-center">
              © 2025 {BrandDetails.name} Powered by Uniplug Digitals. All rights
              reserved.
            </p>
